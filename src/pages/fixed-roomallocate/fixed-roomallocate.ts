...
/**
 * Generated class for the FixedRoomallocatePage page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
@Component({
  selector: 'page-fixed-roomallocate',
  templateUrl: 'fixed-roomallocate.html',
})
export class FixedRoomallocatePage {
